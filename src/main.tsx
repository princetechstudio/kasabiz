  ...
  root.innerHTML = `
    <main style="min-height:100vh;display:grid;place-items:center;padding:24px;background:#f2f5fb;color:#0e1b33;font-family:Arial,sans-serif">
      <section style="max-width:520px;padding:32px;border:1px solid #e2e8f3;border-radius:16px;background:#fff;box-shadow:0 10px 28px rgba(10,31,68,.12)">
        <h1 style="margin:0 0 12px;font-size:24px">Sika Boafo is being configured</h1>
        <p style="margin:0;line-height:1.6;color:#4f607e">The deployment is missing its Supabase connection settings. Add <strong>VITE_SUPABASE_URL</strong> and <strong>VITE_SUPABASE_ANON_KEY</strong> in Vercel, then redeploy.</p>
      </section>
    </main>
  `;
} else {
