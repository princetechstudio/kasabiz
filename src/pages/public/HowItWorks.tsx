    ...
    <div>
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pt-16 lg:pt-20">
        <div className="public-hero relative overflow-hidden rounded-3xl bg-brand-soft border border-brand/10 p-8 sm:p-14 animate-fade-up">
          ...
          <p className="text-sub text-lg leading-relaxed mt-5 max-w-2xl">KasaBiz fits around how Ghanaian businesses already work, so your first useful report is never weeks away.</p>
          </div>
        </div>
      </section>
      <HowItWorksSection />
      <div className="text-center pb-16">
        <Link to="/register"><Button size="lg">Create your free account <ArrowRight className="size-4" /></Button></Link>
      </div>
    </div>
  );
}
